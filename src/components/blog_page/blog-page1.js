...
class BlogPage1 extends Component {
                ...
                <div className='block'>
                  ...
                  <div className='media'>
                    ...
                    <div className='media-body'>
                      ...
                      <span>
                        <i className='far fa-clock'></i>Dec,25,2019
                      </span>
                    </div>
                  </div>
                  <div className='media'>
                  ...
                  <div className='pro-socials'>
                    ...
                    <ul>
                      <li>
                        <Link
                          to='#'
                          className='fab fb fa-facebook-square'
                        ></Link>
                      </li>
                      <li>
                        <Link
                          to='#'
                          className='fab tw fa-twitter-square'
                        ></Link>
                      </li>
                      <li>
                        <Link to='#' className='fab sk fa-skype'></Link>
                      </li>
                      <li>
                        <Link to='#' className='fab ln fa-linkedin'></Link>
                      </li>
                      <li>
                        <Link to='#' className='fab ig fa-instagram'></Link>
                      </li>
                    </ul>
                  </div>
                </div>
